...
export default function CheckoutForm({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center p-0 sm:p-4 select-none dir-rtl animate-fade-in">
      ...
      {/* Modal Box */}
      <div className="relative w-full max-w-lg bg-white dark:bg-dark-900 border border-stone-200 dark:border-white/10 rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[90vh] flex flex-col animate-slide-up overflow-hidden z-10">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-stone-200 dark:border-white/10">
          <div>
            <h2 className="font-bold text-lg sm:text-xl text-stone-900 dark:text-white">إتمام طلب الأكل الحرش</h2>
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-stone-100 dark:bg-white/5 hover:bg-stone-200 dark:hover:bg-white/10 flex items-center justify-center text-stone-500 hover:text-stone-900 dark:hover:text-white transition-colors text-sm font-bold disabled:opacity-50"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`py-3 px-3 rounded-2xl font-bold text-xs sm:text-sm border transition-all flex flex-col items-center gap-1 ${
                  orderType === 'delivery'
          ...
          {orderType === 'delivery' && (
            <div className="space-y-1 animate-fade-in">
              ...
              <input
                ...
                disabled={isSubmitting}
                className="w-full px-4 py-2.5 bg-stone-50 dark:bg-white/5 border border-stone-200 dark:border-white/10 text-stone-900 dark:text-white rounded-xl focus:outline-none focus:border-primary-500 transition-all text-xs sm:text-sm placeholder:text-stone-400"
              />
            ...
            <div className="p-3.5 bg-gold-500/10 border border-gold-500/25 rounded-2xl space-y-2.5 animate-fade-in text-right">
              ...
              <div className="space-y-2 pt-1 border-t border-gold-500/20">
                ...
                <label
                  ...
                  className={`w-full py-2.5 px-3 rounded-xl border-2 border-dashed flex items-center justify-center gap-2 cursor-pointer transition-all text-xs font-bold ${
                    isUploadingReceipt
                ...
                <input
                  ...
                  disabled={isSubmitting || isUploadingReceipt}
                  className="w-full px-3 py-2 bg-white dark:bg-white/5 border border-stone-200 dark:border-white/10 rounded-xl text-xs text-stone-900 dark:text-white placeholder:text-stone-400 focus:outline-none focus:border-primary-500"
                />
              </div>
            </div>
          )}
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              disabled={isSubmitting}
              dir="ltr"
              className={`w-full px-4 py-2.5 bg-stone-50 dark:bg-white/5 border rounded-xl focus:outline-none transition-all text-xs sm:text-sm text-left ${
                phoneError
                  ? 'border-red-500'
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={2}
              disabled={isSubmitting}
              className="w-full px-4 py-2 bg-stone-50 dark:bg-white/5 border border-stone-200 dark:border-white/10 text-stone-900 dark:text-white rounded-xl focus:outline-none focus:border-primary-500 transition-all text-xs resize-none placeholder:text-stone-400"
            />
          </div>
          ...
          {/* Submit Error Banner */}
          {submitError && (
            <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-xl text-red-600 dark:text-red-400 text-xs font-bold text-center">
              {submitError}
            </div>
          )}
          ...
          <button
            ...
            className="w-full btn-primary py-3.5 rounded-2xl text-sm sm:text-base font-bold flex items-center justify-center gap-2 shadow-lg shadow-primary-600/30 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            {isSubmitting ? (
